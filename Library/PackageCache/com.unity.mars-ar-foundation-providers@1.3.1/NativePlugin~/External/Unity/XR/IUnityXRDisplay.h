...
typedef struct XR_PROVIDER UnityXRDisplayGraphicsThreadProvider
{
    ...
    UnitySubsystemErrorCode(UNITY_INTERFACE_API * BlitToMirrorViewRenderTarget)(UnitySubsystemHandle handle, void* userData, const UnityXRMirrorViewRenderTargetDescriptor * mirrorViewRenderTargetDesc);
...
typedef struct XR_PROVIDER UnityXRDisplayProvider
{
    ...
    UnitySubsystemErrorCode(UNITY_INTERFACE_API * QueryMirrorViewBlitDesc)(UnitySubsystemHandle handle, void* userData, const UnityXRMirrorViewRenderTargetDescriptor* mirrorRtDesc, UnityXRMirrorViewBlitDesc * blitDescriptor);
    // PLANNED: OnPause
