...
namespace UnityEngine.AI
{
    ...
    public class NavMeshLink : MonoBehaviour
    {
        ...
        static readonly List<NavMeshLink> k_Tracked = new List<NavMeshLink>();
        ...
        void AddLink()
        {
            ...
            m_LinkInstance = NavMesh.AddLink(link, thisTransform.position, thisTransform.rotation);
            if (m_LinkInstance.valid)
                m_LinkInstance.owner = this;

            m_LastPosition = thisTransform.position;
            m_LastRotation = thisTransform.rotation;
        }
        ...
        {
            foreach (var instance in k_Tracked)
            {
        ...
        void OnValidate()
        {
            ...
            else if (!k_Tracked.Contains(this))
            {
                AddTracking(this);
            }
        }
