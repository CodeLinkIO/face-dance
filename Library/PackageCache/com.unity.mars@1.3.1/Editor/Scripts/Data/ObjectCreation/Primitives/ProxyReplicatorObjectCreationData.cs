...
{
    class ProxyReplicatorObjectCreationData : ObjectCreationData
    {
        public override bool CreateGameObject(out GameObject createdObj, Transform parentTransform = null)
        {
            ...
            createdObj.AddComponent<Replicator>();

            var childProxy = new GameObject("Proxy Object");
            childProxy.AddComponent<Proxy>();
            childProxy.AddComponent<HasPoseCondition>();
            childProxy.AddComponent<ShowChildrenOnTrackingAction>();
            childProxy.AddComponent<SetPoseAction>();
            childProxy.transform.parent = createdObj.transform;
