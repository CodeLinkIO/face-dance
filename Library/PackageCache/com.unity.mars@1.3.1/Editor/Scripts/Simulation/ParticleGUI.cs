...
{
    // Copied from ParticleGUI.cs
    static class ParticleGUI
    {
        ...
        public static void SetMaterialKeywords(Material material)
        {
            ...
            if (material.HasProperty("_FlipbookBlending"))
            {
                ...
                SetKeyword(material, "_FLIPBOOKBLENDING_ON", useFlipbookBlending);
            }
            // Soft particles
            ...
            if (material.HasProperty("_SoftParticlesEnabled"))
            {
                ...
                SetKeyword(material, "_SOFTPARTICLES_ON", useSoftParticles);
            }
            // Camera fading
