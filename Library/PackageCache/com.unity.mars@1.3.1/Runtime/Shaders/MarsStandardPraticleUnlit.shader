Shader "MARS/Particle/Standard Unlit"
{
    Properties
    {
        // MARS/Legacy/Particles Standard Unlit properties
    ...
    SubShader
    {
        ...
        UsePass "Universal Render Pipeline/Particles/Unlit/ForwardLit"
    }

    Fallback "MARS/Legacy/Particles/Standard Unlit"
    CustomEditor "UnityEditor.MARS.Rendering.MarsParticleMaterialInspector"
}
